              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
				  ...
				  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="<?php echo esc_url($image_url); ?>" width="674" height="674" alt="" />
                    <a data-fancybox="gallery" href="<?php echo esc_url($image_url); ?>" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
              ...
              <div class="swiper-container">
				...
				<?php
						...
						foreach ($attachment_ids as $attachment_id) {
							$image_url = wp_get_attachment_url($attachment_id); ?>
							<div class="swiper-slide product-single__image-item">
								<img loading="lazy" class="h-auto" src="<?php echo esc_url($image_url); ?>" width="104" height="104" alt="" />
							</div>
				<?php } ?>
        ...
        <div class="col-lg-5">
          <div class="d-flex justify-content-between mb-4 pb-md-2">
            <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
              ...
              <a href="<?php echo home_url('/shop'); ?>" class="menu-link menu-link_us-s text-uppercase fw-medium">The Shop</a>
            </div><!-- /.breadcrumb -->
          ...
          <h1 class="product-single__name"><?php echo esc_html(get_the_title()); ?></h1>
          <div class="product-single__rating">
            ...
            <span class="reviews-note text-lowercase text-secondary ms-1"> <?php echo esc_html($product->get_review_count()); ?>  reviews</span> 
          </div>
          <div class="product-single__price">
            <span class="current-price"><?php echo wc_price($product->get_price()); ?></span>
          </div>
          <div class="product-single__short-desc"> 
		    <?php echo  $short_description = $product->get_short_description(); ?>
	     </div>
          <form name="addtocart-form" method="post">
              ...
              <div class="product-swatch text-swatches">
				...
				<?php 
						if ($product) {
							...
							$attributes = $product->get_attributes('pa_size');
							foreach($attributes['pa_size']['options'] as $size_id){
							$selected_size =  get_term_by('term_id', $size_id, 'pa_size');   
				?>

						<input type="radio" name="size" id="swatch-1">
						<label class="swatch js-swatch" for="swatch-1" aria-label="Extra Small" data-bs-toggle="tooltip" data-bs-placement="top" title="Extra Small">
							<?php echo  $selected_size->name ; ?>
						</label> 
              ...
              <div class="product-swatch color-swatches">
				...
				<?php 
						if ($product) {
							...
							foreach($attributes['pa_color']['options'] as $color_id){
							// $selected_color =  get_term_by('term_id', $color_id, 'pa_color');  
							$get_clr =  get_term_meta($color_id,'color-attribute', true); 
				?>

						

					   <input type="radio" name="color" id="swatch-11">
                       <label class="swatch swatch-color js-swatch" for="swatch-11" aria-label="Black" data-bs-toggle="tooltip" data-bs-placement="top" title="Black" style="color: <?php echo $get_clr; ?>">
					   </label>
            ...
            <div class="product-single__addtocart">
              ...
              <button type="submit" class="btn btn-primary add_to_cart_btn btn-addtocart js-open-aside" data-aside="cartDrawer">Add to Cart</button>
            </div>
          </form>
